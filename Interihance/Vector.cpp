...
namespace OOPLabs 
{
	...
	Vector& Vector::operator=(const matrix& mtr)
	{
		...
		if (mtr.Height() == 1 || mtr.Height() == 0)
		{
			...
			throw Exception(11, ind);
		return *this;
	}
	matrix operator*(const Vector& l, const Vector& r)
	{
		matrix mtr = l;
		return mtr *= (r.transpon());
	}
	...
	//	return *this;
	//}
	//matrix& Vector::operator*=(const Vector& Vec)
	//{
	//	matrix::operator*=(Vec.transpon());
	//	return *this;
	//}
